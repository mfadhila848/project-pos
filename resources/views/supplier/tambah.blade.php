...
@section('title')
  <title>Supplier Page | Nama Perusahaan</title>
@endsection
            ...
            <form action="" method="POST">
                ...
                <div class="form-group row">
                    <div class="form-group" style="width: 95%; margin: auto;">
                        ...
                        <input type="number" class="form-control" id="salesman" placeholder="Salesman" name="salesman">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="form-group" style="width: 95%; margin: auto;">
                        <label for="bank">Bank</label>
                        <input type="number" class="form-control" id="bank" placeholder="Bank" name="bank">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="form-group" style="width: 95%; margin: auto;">
