    ...
    <tbody>
        @foreach ($merek as $item)
            <tr>
                ...
                <td>{{ $item->nama }}</td>
                <td>
                    <button class="btn" type="button" style="color: green;" title="Edit" data-mode="edit" data-toggle="modal" data-target="#formModalBarang" data-id_merek="{{ $item->id }}" data-nama_merek="{{ $item->nama }}">
